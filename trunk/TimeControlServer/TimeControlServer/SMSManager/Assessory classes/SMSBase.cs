...
namespace TimeControlServer
{
    ...
    public abstract class SMSBase
    {
        ...
        /// <summary>
        /// Used to pack 7-bit ASCII in to 8-bit PDU,
        /// Implemented by [www.codeproblem.com]
        /// </summary>
        /// <param name="sms">SMS to be packed</param>
        /// <returns>bytes of packed PDU</returns>
        public static byte[] Encode7bit(string sms)
        {
            ...
            int arrayLength = (int)(sms.Length - Math.Floor(((double)sms.Length / 8)));
        ...
        public static byte[] Encode8bit(string s)
        {
            return new byte[1];
        }
